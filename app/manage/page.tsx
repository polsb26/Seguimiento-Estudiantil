    ...
    return (
        <>
            ...
            <div className="flex justify-between px-96">
                <div onClick={() => router.push('/manage/estudiantes')} className="w-80 h-96 flex flex-col justify-center items-center border-4 border-solid rounded-xl bg-white border-color">
                    <Image
                        src={ESTUDIANTES}
                ...
                <div onClick={() => router.push('/manage/egresados')} className="w-80 h-96 flex flex-col justify-center items-center border-4 border-solid rounded-xl bg-white border-color ">
                    <Image
                        src={EGRESADOS}
                        alt="ICONO ESTUDIANTES"
                        width={190}
